...
CREATE TABLE `admin`  (
  ...
  `username` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '管理员用户名',
  `password` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '登录密码',
...
CREATE TABLE `bank`  (
  ...
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '银行名称',
  `type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '银行类型',
  `assets` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '资产',
  `bankDesc` varchar(20000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '银行描述',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `bankcard`  (
  ...
  `cardBank` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '银行卡所属银行',
  `type` int NULL DEFAULT NULL COMMENT '银行卡类型（1：借记卡  2：信用卡）',
  `cardNum` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '银行卡号',
...
CREATE TABLE `change_money`  (
  ...
  `name` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '理财产品名称',
  `annualIncome` decimal(10, 8) NULL DEFAULT NULL COMMENT '七日年化收益率',
  `peiIncome` decimal(10, 2) NULL DEFAULT NULL COMMENT '每万元收益',
  `invesTerm` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '投资期限',
...
CREATE TABLE `flow_of_funds`  (
  ...
  `source` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '来源',
  `createTime` date NULL DEFAULT NULL COMMENT '创建时间',
  `fundDesc` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `flow_of_funds` VALUES (18, 1, 100.00, 1, '支付宝零钱理财', '2024-03-06', '无');
INSERT INTO `flow_of_funds` VALUES (19, 1, 2000.00, 1, '工资理财', '2024-03-06', '期货');
INSERT INTO `flow_of_funds` VALUES (20, 1, 100.00, 1, '长信利发债券', '2024-03-06', '无');
INSERT INTO `flow_of_funds` VALUES (21, 1, 8000.00, 1, 'P2P期限理财', '2024-03-06', '无');
INSERT INTO `flow_of_funds` VALUES (22, 1, 300.00, 1, '理财通零钱理财', '2024-03-06', '无');
...
CREATE TABLE `fund_product`  (
  ...
  `fundDesc` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '基金简称',
...
CREATE TABLE `info`  (
  ...
  `title` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '消息标题',
  `infoDesc` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '消息内容',
...
CREATE TABLE `news`  (
  ...
  `newsDesc` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '内容',
...
CREATE TABLE `permissions`  (
  ...
  `permission` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '权限描述',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `term_financial`  (
  ...
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '产品名称',
  `invesTerm` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '投资期限',
  `leastMoney` decimal(10, 2) NULL DEFAULT NULL COMMENT '起投金额',
...
CREATE TABLE `user`  (
  ...
  `reputation` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户信誉',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = COMPACT;
...
INSERT INTO `user_change_money` VALUES (16, 1, 1, '2024-03-06', 0.03435000, 3.44, 1);
INSERT INTO `user_change_money` VALUES (17, 1, 3, '2024-03-06', 0.03222000, 9.67, 1);
...
INSERT INTO `user_fund_product` VALUES (5, 1, 2, '2024-03-06', 0.03030000, 3.03, 1);
...
INSERT INTO `user_pay_money` VALUES (9, 1, 2, '2024-03-06', 0.03123000, 62.46, 1);
...
INSERT INTO `user_term_financial` VALUES (6, 1, 2, '2024-03-06', 0.04371000, 349.68, 1);
